...
<asp:Content ID="header" ContentPlaceHolderID="head" runat="server">
    ...
    <BulkManager:JSRenderControl ID="JsRenderControl" runat="server"></BulkManager:JSRenderControl>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            setSelectedColumnsField('<%=SelectedColumnsField.ClientID%>');
            setPluginFolder('<%=PluginFolder%>');
            intializeBulkManagerForm();
        });

        function selectDictionaryItem(id, nodeName) {
            
            var picker = Umbraco.Controls.TreePicker.inst[1];
                $("#" + picker._itemTitleClientID)
                            .html(nodeName)
                            .parent()
                                .show();
                $("#" + picker._itemIdValueClientID).val(id);
...
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="server">
    <umbraco:UmbracoPanel ID="UmbracoPanel" runat="server" DefaultButton="SearchButton">
        ...
        <asp:Panel runat="server" ID="ContentPanel">
            ...
            <asp:HiddenField runat="server" ID="SelectedColumnsField" />
