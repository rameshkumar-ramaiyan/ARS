...
(function ($) {
    ...
    tinymce.PluginManager.add('fsmediapicker', function (editor) {
        ...
        function populate(path) {
            ...
            var text = editor.selection.getContent() ? editor.selection.getContent() : path

            if ((/\.(jpe?g|png|gif)$/i).test(path)) {
        ...
        editor.addButton('fsmediapicker', {
            ...
            tooltip: 'File System Image Picker',
            onclick: function () {
                ...
                $http.get('/umbraco/backoffice/FileSystemPicker/FileSystemPickerApi/GetCommonConfig/')
                    .then(function (response) {
                        ...
                        $http.get('/umbraco/backoffice/FileSystemPicker/FileSystemPickerApi/GetStartFolderName/?startFolderNamePropertyAlias=' + alias + '&currentNodeId=' + id + '&removeCharactersPropertyAlias=')
                            .then(function (response) {
